...
#     opt = TrainOptions().parse()   # get training options
    ...
    victime_net.eval()
    teacher_outputs=[]
    teacher_outputs = get_teacher_output(teacher_model=victime_net, 
    ...
    visualizer = Visualizer(trainer_opt.checkpoints_dir)   # create a visualizer that display/save images and plots
